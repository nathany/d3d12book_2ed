// Port of `Demos/C7_Waves/Waves.h/.cpp` (Frank Luna) — performs the calculations for the
// wave simulation (the finite-difference scheme from the book's appendix). After the
// simulation has been updated, the client must copy the current solution into vertex
