// Port of `Demos/C8_LitShapes/FrameResource.h/.cpp` (Frank Luna) — the per-frame buffers
// now use the full shared-header types (common/shared_types.odin), and each frame carries
// a material StructuredBuffer alongside the pass constants.
