// Port of `Demos/C8_LitWaves/FrameResource.h/.cpp` (Frank Luna) — like C8_LitShapes' plus
// the per-frame dynamic wave vertex buffer, now carrying full ModelVertex data (the
// lighting needs the per-vertex normals).
package c8_litwaves
...
Frame_Resource :: struct {
	...
	waves_vb:        common.Upload_Buffer(common.Model_Vertex),
