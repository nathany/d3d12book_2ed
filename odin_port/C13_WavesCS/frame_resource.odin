// Port of `Demos/C13_WavesCS/FrameResource.h/.cpp` (Frank Luna). GPU waves remove the
// CPU demo's per-frame dynamic vertex buffer and add compute-root argument names.
