// Port of `Demos/C10_BlendDemo` (BlendDemoApp.cpp/.h) — the textured hills-and-waves
...
update_waves :: proc(app: ^Blend_Demo_App) {
...
// C++: BlendDemoApp::BuildWaveGeometry — static 32-bit indices, matching the book.
